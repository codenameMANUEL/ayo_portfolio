...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-screen text-center px-4 pt-[80px] sm:pt-[90px] md:pt-[60px] font-cinzel">
        <h1 className="text-[8vw] sm:text-9xl md:text-xl lg:text-8xl xl:text-5xl font-extrabold leading-tight pt-20 text-stone-400">
          Hi <span className="inline-block">{letters}</span>
        </h1>
        <div className="px-4 sm:px-8">
          ...
          <p className="text-lg sm:text-xl md:text-2xl sm:mt-6 text-start">
            <span className="text-stone-400">
              Security Delivery Specialist at
            </span>{" "}
