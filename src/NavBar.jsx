...
// const Navbar = () => {
//   return (
//     <nav className="bg-white/10 backdrop-blur-md backdrop-saturate-150 border border-white/20 px-8 py-4 rounded-xl flex gap-14 items-center shadow-xl w-fit md:w-[600px] lg:w-[700px] xl:w-[800px] mx-auto mt-10 justify-center transition-all duration-500 hover:shadow-2xl hover:scale-105">
//       <a href="#">
...
// const Navbar = () => {
//   return (
//     <nav className="hidden sm:flex bg-white/10 backdrop-blur-md backdrop-saturate-150 border border-white/20 px-8 py-4 rounded-xl gap-14 items-center shadow-xl w-fit md:w-[600px] lg:w-[700px] xl:w-[800px] mx-auto mt-10 justify-center transition-all duration-500 hover:shadow-2xl hover:scale-105">
//       <a href="#">
//         <img src={logo} alt="Logo" className="h-12 w-auto transition-transform duration-300 hover:scale-110" />
//       </a>
//       <a href="#" className="hover:text-gray-400 transition-colors duration-300">About</a>
